...
{
    public partial class UC_Mail_Elementos_Eliminados : UserControl
    {
        public UC_Mail_Elementos_Eliminados()
        {
            InitializeComponent();
        }
        ...
        public void mostrar_mensajes(string direccionCorreo, int NumPag)
        {
            try
            {
                ...
                listaMensajes = new BindingList<mail_Mensaje_Info>(MenBus.consultar(eTipoMail.Eliminado, direccionCorreo, 1, uC_Botones_Paginas1.Total_Registros_x_pagina, (uC_Botones_Paginas1.Cadena_Busqueda == null) ? "" : uC_Botones_Paginas1.Cadena_Busqueda, ref msg));

                foreach (var item in listaMensajes)
                {
                    item.Checked = true;
                }
                NumeroPaginas = Bus_Mensaje.ObtenerNumPag(uC_Botones_Paginas1.Total_Registros_x_pagina, eTipoMail.Eliminado, dir_correo, (uC_Botones_Paginas1.Cadena_Busqueda == null) ? "" : uC_Botones_Paginas1.Cadena_Busqueda, ref msg);
