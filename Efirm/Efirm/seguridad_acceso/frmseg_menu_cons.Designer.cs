...
namespace Efirm
{
    partial class frmseg_menu_cons
    {
        ...
        {
            this.ucge_menu_superior_cons1 = new Core.Erp.Winform.controles.ucge_menu_superior_cons();
            ...
            this.ucge_menu_superior_cons1.event_delegate_btn_nuevo_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_cons.delegate_btn_nuevo_ItemClick(this.ucge_menu_superior_cons1_event_delegate_btn_nuevo_ItemClick);
            this.ucge_menu_superior_cons1.event_delegate_btn_modificar_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_cons.delegate_btn_modificar_ItemClick(this.ucge_menu_superior_cons1_event_delegate_btn_modificar_ItemClick);
            this.ucge_menu_superior_cons1.event_delegate_btn_consultar_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_cons.delegate_btn_consultar_ItemClick(this.ucge_menu_superior_cons1_event_delegate_btn_consultar_ItemClick);
            this.ucge_menu_superior_cons1.event_delegate_btn_anular_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_cons.delegate_btn_anular_ItemClick(this.ucge_menu_superior_cons1_event_delegate_btn_anular_ItemClick);
            this.ucge_menu_superior_cons1.event_delegate_btn_imprimir_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_cons.delegate_btn_imprimir_ItemClick(this.ucge_menu_superior_cons1_event_delegate_btn_imprimir_ItemClick);
            this.ucge_menu_superior_cons1.event_delegate_btn_salir_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_cons.delegate_btn_salir_ItemClick(this.ucge_menu_superior_cons1_event_delegate_btn_salir_ItemClick);
            // 
            // treeListMenu
            // 
        ...
        private controles.ucge_menu_superior_cons ucge_menu_superior_cons1;
