...
namespace Efirm
{
    partial class frmseg_menu_mant
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.menu.event_delegate_btn_salir_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_mant.delegate_btn_salir_ItemClick(this.menu_event_delegate_btn_salir_ItemClick);
            this.menu.event_delegate_btn_anular_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_mant.delegate_btn_anular_ItemClick(this.menu_event_delegate_btn_anular_ItemClick);
            this.menu.event_delegate_btn_limpiar_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_mant.delegate_btn_limpiar_ItemClick(this.menu_event_delegate_btn_limpiar_ItemClick);
            this.menu.event_delegate_btn_guardar_salir_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_mant.delegate_btn_guardar_salir_ItemClick(this.menu_event_delegate_btn_guardar_salir_ItemClick);
            this.menu.event_delegate_btn_guardar_ItemClick += new Core.Erp.Winform.controles.ucge_menu_superior_mant.delegate_btn_guardar_ItemClick(this.menu_event_delegate_btn_guardar_ItemClick);
            // 
            // frmseg_menu_mant
            // 
