namespace Efirm
{
    partial class frmseg_usuario_cons
    {
        ...
        {
            this.menu = new Efirms.ucge_menu_superior_cons();
            ...
            this.menu.event_delegate_btn_nuevo_ItemClick += new Efirms.ucge_menu_superior_cons.delegate_btn_nuevo_ItemClick(this.menu_event_delegate_btn_nuevo_ItemClick);
            this.menu.event_delegate_btn_modificar_ItemClick += new Efirms.ucge_menu_superior_cons.delegate_btn_modificar_ItemClick(this.menu_event_delegate_btn_modificar_ItemClick);
            this.menu.event_delegate_btn_consultar_ItemClick += new Efirms.ucge_menu_superior_cons.delegate_btn_consultar_ItemClick(this.menu_event_delegate_btn_consultar_ItemClick);
            this.menu.event_delegate_btn_anular_ItemClick += new Efirms.ucge_menu_superior_cons.delegate_btn_anular_ItemClick(this.menu_event_delegate_btn_anular_ItemClick);
            this.menu.event_delegate_btn_imprimir_ItemClick += new Efirms.ucge_menu_superior_cons.delegate_btn_imprimir_ItemClick(this.menu_event_delegate_btn_imprimir_ItemClick);
            this.menu.event_delegate_btn_salir_ItemClick += new Efirms.ucge_menu_superior_cons.delegate_btn_salir_ItemClick(this.menu_event_delegate_btn_salir_ItemClick);
            // 
        ...
        private Efirms.ucge_menu_superior_cons menu;
