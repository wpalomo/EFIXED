...
namespace FirmaElect.GenerarXML
{
    public partial class Service1 : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            aTimer.Elapsed += new ElapsedEventHandler(TimeEjecucion);
            aTimer.Interval = TimeSpan.FromMinutes(1).TotalMinutes;
            aTimer.Enabled = true;
        }

        private void TimeEjecucion(object sender, ElapsedEventArgs e)
        {
            try
            {
