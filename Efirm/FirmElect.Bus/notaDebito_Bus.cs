...
{
   public class notaDebito_Bus
    {


       public Boolean Validar_xml_vs_sxd(XmlDocument xmlCbteNotaDeb, ref string MensajeOut)
       {
           ...
           try
           {
               ...
               string xsdString = "";
               xsdString = FirmElect.Info.Properties.Resources.notaDebito;
               ...
               ///
               XmlReader rdr = XmlReader.Create(new StringReader(xmlCbteNotaDeb.InnerXml), settings);
               while (rdr.Read()) { }
