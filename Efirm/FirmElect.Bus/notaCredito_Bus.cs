...
{
   public class notaCredito_Bus
    {

       public Boolean Validar_xml_vs_sxd(XmlDocument xmlCbteNotaCred, ref string MensajeOut)
       {
           ...
           try
           {
               ...
               string xsdString = "";
               xsdString = FirmElect.Info.Properties.Resources.notaCredito;
               ...
               ///
               XmlReader rdr = XmlReader.Create(new StringReader(xmlCbteNotaCred.InnerXml), settings);
               while (rdr.Read()) { }
